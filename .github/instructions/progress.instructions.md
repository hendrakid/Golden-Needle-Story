...
main_characters:
  ...
  - name: "Taji"
    role: "Ally 1 / Mercenary Archer / Ranged DPS"
    species: "Ajag (Wild Dog / Dhole)"
    archetype: "The Lone Wolf / The Mercenary with a Heart / The Outcast Hunter"
    brief: "Mercenary archer exiled from birth pack after refusing morally corrupt hunt; lone hunter seeking to prove self-sufficiency while secretly craving pack connection; ranged DPS and master tracker; recruited Q006; character arc: learns chosen family is stronger than blood family, pack loyalty earned is more real than loyalty inherited"
    appears: "Q006 (ACT 2A)"
    wound: "Exiled from birth pack for choosing conscience over tradition; notched ear as mark of exile"
    growth: "'Packs always betray' → 'Chosen family is real family'"
    
  - name: "Senja"
    role: "Ally 2 / Shadow Mage / Support Caster & Utility"
    species: "Musang (Palm Civet)"
    archetype: "The Sheltered Prodigy / The Naive Scholar / The Idealist Awakening"
    brief: "Apprentice of deceased Great Wizard (Owl mage named Wulan); shadow/support magic specialist; sheltered prodigy learning harsh realities of world beyond books; struggles with survivor's guilt over master's death in magical accident; utility caster and strategist; recruited Q009; character arc: learns magic is tool not solution, people matter more than power, master died from love not weakness"
    appears: "Q009 (ACT 2A)"
    wound: "Master died protecting Senja from magical backlash; believes 'If I were stronger, master would still be alive'"
    growth: "'Knowledge and power are everything' → 'Magic serves people, not ego'"
    
  - name: "Licik"
    role: "Ally 3 / Assassin / Stealth DPS & Infiltrator (OPTIONAL)"
    species: "Rubah (Fox / Red Fox)"
    archetype: "The Reformed Criminal / The Pragmatic Survivor / The Trickster Seeking Redemption"
    brief: "Former bandit and assassin seeking to escape criminal past; younger sibling died of starvation while Licik was imprisoned for theft; master lockpicker, stealth expert, and infiltrator; moral complexity character (survival crimes vs. redemption desire); recruited Q013 (optional); brings street wisdom, pragmatism, and darker skill set; character arc: learns survival doesn't make you evil, redemption is ongoing choice not single act, deserves to live AND be better"
    appears: "Q013 (ACT 2B - Optional)"
    status: "OPTIONAL RECRUIT"
    wound: "Sibling died while Licik imprisoned; believes 'I'm alive because I let them die'"
    growth: "'I'm fundamentally selfish' → 'Survival instinct isn't evil; I can choose to be better'"
...
quest_files_created:
  ...
  - "Q013: Recruit Licik - Rubah Assassin (OPTIONAL - Redemption Arc)"
...
implementation_milestones:
  ...
  - date: "2026-04-19"
    milestone: "✅ EXPANDED CHARACTER PROFILES — Taji, Senja, Licik fully detailed with backstories, arcs, combat styles, physical descriptions"
